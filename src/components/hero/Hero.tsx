  ...
  return (
    <section className={`relative h-screen overflow-hidden ${className}`}>
      ...
      <div className="absolute bottom-0 will-change-transform pointer-events-auto 
                      w-[90vw] sm:w-[80vw] md:w-[55vw] lg:w-[50vw] xl:w-[35vw]
                      right-[5vw] sm:right-[10vw] md:right-[2vw] lg:right-[5vw] xl:right-[18vw]
        ...
        <Image
          ...
          className="w-full h-auto select-none object-contain 
                     max-h-[55vh] sm:max-h-[65vh] md:max-h-[85vh] lg:max-h-none
                     transition-all duration-700 ease-out
                     hover:scale-105 hover:brightness-110 hover:drop-shadow-2xl
                     group-hover:rotate-1"
          sizes="(max-width: 640px) 90vw, (max-width: 768px) 80vw, (max-width: 1024px) 55vw, (max-width: 1280px) 50vw, 35vw"
          quality={90}
        />
      </div>
      ...
      <div className="relative z-10 h-full flex items-start md:items-center justify-start 
                      pt-20 sm:pt-24 md:pt-20 md:pl-16 lg:pl-24 xl:pl-32">
        <div className="max-w-[90vw] sm:max-w-[85vw] md:max-w-lg lg:max-w-xl xl:max-w-2xl 
                        px-4 sm:px-6 md:px-12 md:ml-8 lg:ml-12 xl:ml-16 text-left">
          
          {/* Título optimizado para móvil */}
          <h1 className="text-white font-extrabold leading-[1.1] md:leading-tight
          ...
          <p className="text-white/90 text-base sm:text-lg md:text-xl
                        mb-6 sm:mb-8 max-w-[85vw] sm:max-w-none">
