...
async function validateStageTransition(
  ...
  const stages: Record<string, { order: number; name: string }> = {
    ...
    'rechazado': { order: 6, name: 'Rechazado' },
    'credito-rechazado': { order: 6, name: 'Rechazado' },
    'cerrado-perdido': { order: 6, name: 'Cerrado Perdido' },
    'cerrado_perdido': { order: 6, name: 'Cerrado Perdido' },
    'aprobado': { order: 7, name: 'Aprobado' },
    'en-seguimiento': { order: 8, name: 'En Seguimiento' },
    'cerrado-ganado': { order: 9, name: 'Cerrado Ganado' },
    'venta-cerrada': { order: 9, name: 'Cerrado Ganado' },
    'cerrado_ganado': { order: 9, name: 'Cerrado Ganado' },
