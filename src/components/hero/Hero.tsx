...
export default function Hero({ className = "" }: HeroProps) {
  ...
  const [images, setImages] = useState({
    background: "/hero/hero-bg-desktop.jpg",
    foreground: "/hero/hero-fg-desktop.png",
  });
  ...
  return (
    <section className={`relative min-h-screen overflow-hidden ${className}`}>
      ...
      <div className="order-2 md:order-none static md:absolute md:bottom-0 will-change-transform pointer-events-auto z-20
                      ...
                      mx-auto md:mx-0 flex justify-center items-start md:items-end md:justify-end group pt-0 sm:pt-2 translate-y-[24px] sm:translate-y-[18px] md:translate-y-0 translate-x-[14px] sm:translate-x-[16px] md:translate-x-0">
        <Image
          ref={fgRef}
    ...
    <div className="max-w-[86vw] sm:max-w-[80vw] px-4 sm:px-6 mx-auto mt-2 sm:mt-3">
      <div className="flex flex-col sm:flex-row gap-2.5 sm:gap-4">
        <Button asChild variant="fmcCtaPrimary" size="xl" className="font-acto-bold w-full sm:w-auto">
          <a href="#concesionarios">SOLICITÁ TU CRÉDITO AHORA</a>
        </Button>
        <Button asChild variant="fmcCtaWhatsapp" size="xl" className="font-acto-bold w-full sm:w-auto">
          <a href="https://wa.me/543704123456" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2">
      ...
      <div
        className="order-1 md:order-none relative z-30 h-full flex items-start md:items-center justify-start 
                      pt-14 sm:pt-16 md:pt-20 md:pl-16 lg:pl-24 xl:pl-32"
      ...
      >
        <div className="max-w-[86vw] sm:max-w-[80vw] md:max-w-lg lg:max-w-xl xl:max-w-2xl 
          ...
          <h1 className="text-white font-acto-black tracking-tight
            ...
            <span className="text-emerald-400"> Banco Formosa</span>,
            <br className="sm:hidden" />
            accedé al crédito inmediato
            <br className="sm:hidden" />
