          ...
          <div className="flex items-center justify-between">
            ...
            <div className="hidden lg:flex items-center space-x-2 text-sm font-acto" data-aos="fade-down" data-aos-delay="150">
              <div className="flex items-center gap-2">
                ...
                <Link
                  href="/auth/signin"
                  className="inline-flex items-center gap-2 rounded-full bg-white/10 border border-white/20 text-white px-4 py-2 shadow-sm hover:bg-white/20 focus-visible:ring-2 focus-visible:ring-white/40 transition-transform duration-200 ease-out hover:-translate-y-[1px] active:scale-[0.98]"
                >
